  ...
  return (
    ...
    >
      <View style={styles.contentContainer}>
        ...
        <Text style={styles.pergunta}>Você tem tido dificuldade em se concentrar nas tarefas devido a preocupações excessivas?</Text>

        {/* Botões de resposta */}
        <View style={styles.botoesContainer}>
        <View>
        <Link href="pergunta10" asChild>
