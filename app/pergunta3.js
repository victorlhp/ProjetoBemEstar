  ...
  return (
    ...
    >
      <View style={styles.contentContainer}>
        ...
        <Text style={styles.pergunta}>Você tem sentido irritabilidade frequente, mesmo em situações normais?</Text>

        {/* Botões de resposta */}
        <View style={styles.botoesContainer}>
          <View>
            <Link href="pergunta4" asChild>
