  ...
  return (
    ...
    >
      <View style={styles.contentContainer}>
        ...
        <Text style={styles.pergunta}>Você se sente frequentemente sobrecarregado(a) ou incapaz de relaxar?</Text>

        {/* Botões de resposta */}
        <View style={styles.botoesContainer}>
          <View>
            <Link href="pergunta7" asChild>
